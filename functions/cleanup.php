...
return '<span title="'. __('Read', 'jointswp') . get_the_title($post->ID).'">'. __('...', 'jointswp') .'</a><br/><a class="button" href="'. get_permalink($post->ID) . '" title="'. __('Read More', 'jointswp') . get_the_title($post->ID).'">'. __('Read More', 'jointswp') .'</a>';
// return '<span class="excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __('Read', 'jointswp') . get_the_title($post->ID).'">'. __('... Read more &raquo;', 'jointswp') .'</a>';
}
